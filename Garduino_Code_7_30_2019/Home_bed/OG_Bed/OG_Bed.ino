...
AdafruitIO_Feed *temperature = io.feed("temperatureOG");
AdafruitIO_Feed *humidity = io.feed("humidityOG");
AdafruitIO_Feed *light_level = io.feed("light_levelOG");
AdafruitIO_Feed *moisture = io.feed("moistureOG");
AdafruitIO_Feed *instruction = io.feed("instructionOG");
